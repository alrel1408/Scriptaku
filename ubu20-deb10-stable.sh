...
# // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  Developer » ALRELSHOP࿐${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
...
function first_setup(){
    ...
    if [[ $(cat /etc/os-release | grep -w ID | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/ID//g') == "ubuntu" ]]; then
        ...
        if [[ $OS_VERSION == "18.04" ]] || [[ $OS_VERSION == "20.04" ]]; then
            ...
            # For Ubuntu 22.04, 24.04, 25.04 use default haproxy
        ...
        if [[ $OS_VERSION == "9" ]] || [[ $OS_VERSION == "10" ]]; then
            ...
            # For Debian 11, 12 use default haproxy
            sudo apt-get update
            apt-get -y install haproxy
        fi
    else
